...
import { ArrowRight, Search, RefreshCw, Shield } from "lucide-react";
    ...
    <div className="space-y-6 p-4 md:p-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">سجلات النظام</h1>
            <p className="text-muted-foreground text-sm mt-0.5">
              {data?.total ?? 0} سجل إجمالي
            </p>
          </div>
        </div>
        <button
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    <th className="text-right px-4 py-3 text-sm font-medium text-muted-foreground">الإجراء</th>
                    <th className="text-right px-4 py-3 text-sm font-medium text-muted-foreground">التفاصيل</th>
                    <th className="text-right px-4 py-3 text-sm font-medium text-muted-foreground">IP</th>

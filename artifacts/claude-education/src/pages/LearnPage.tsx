...
const sectionMeta: Record<string, { category: Category; titleAr: string; titleEn: string }> = {
  ...
  "cli":                  { category: "beginner",     titleAr: "واجهة سطر الأوامر",             titleEn: "CLI Reference" },
  ...
  "skills":               { category: "intermediate", titleAr: "المهارات",                     titleEn: "Skills" },
  "checkpoints":          { category: "intermediate", titleAr: "نقاط التفتيش",                 titleEn: "Checkpoints" },
  ...
  "plugins":              { category: "advanced",     titleAr: "الإضافات",                     titleEn: "Plugins" },
  "advanced":             { category: "advanced",     titleAr: "الميزات المتقدمة",              titleEn: "Advanced Features" },
